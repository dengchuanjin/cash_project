  ...
  <section id="wrap">
    ...
    <el-dialog title="修改商户" :visible.sync="updateCashUserDialog">
      <el-form :model="cashUserObj"  size="small">
        ...
        <el-form-item label="是否自动提现" label-width="100px" :required="isOff">
        ...
        <el-form-item label="是否启用添加乘客功能" label-width="200px" :required="isOff">
        ...
        <el-form-item label="班次提前多少分钟可微信购票" label-width="220px" :required="isOff">
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      //添加提交
      addCashUserSubmit(){
        if(this.AddCashUser.Sid==''
          ||this.AddCashUser.SPassword==''
          ||this.AddCashUser.SName==''
          ||this.AddCashUser.SFreeRate==''
          ||this.AddCashUser.SType==''
          ||this.AddCashUser.WeDo==''
        ){
          this.$message({
            showClose: true,
            message: '输入内容不能为空！',
      ...
      updateCashUserSubmit(){
        if(this.cashUserObj.Sid==''
          ||this.cashUserObj.SPassword==''
          ||this.cashUserObj.SName==''
          ||this.cashUserObj.SType==''
          ||this.cashUserObj.WeDo==''
          ||this.cashUserObj.SAutoOut==''
          ||this.cashUserObj.SWebServiceType==''
          ||this.cashUserObj.SPassengerUse==''
          ||this.cashUserObj.SSaleHalf==''
          ||this.cashUserObj.SSaleFree==''
          ||this.cashUserObj.SAllSale==''
          ||this.cashUserObj.SSellTimeLimit==''
          ||this.cashUserObj.ISDelete==''
        ){
          this.$message({
            showClose: true,
            message: '输入内容不能为空！',
