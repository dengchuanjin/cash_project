            ...
            <div class="sidebar-category sidebar-category-visible">
              <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                  ...
                  <!--非管理员-->
                  <li v-else="isAdmin">
                    <a href="javascript:;"><i class="icon-redo2"></i> <span>商户提现管理</span></a>
                    <!--商户-->
                    <ul>
                      <li>
                        <router-link to="/home/information">商户信息</router-link>
                      </li>
                      <li>
                      ...
                      <li>
                        <router-link to="/home/purseRecharge">钱包充值</router-link>
                      </li>
                      <li>
                        <router-link to="/home/purseDetail">充值明细</router-link>
                      </li>
                      <li>
                        <router-link to="/home/consumptionDetail">消费明细</router-link>
                      </li>
                    </ul>
                  </li>
                  <!-- /main -->
...
<script>
  ...
  export default{
    ...
    methods:{
      ...
      //初始化数据
      initData(){
        this.$store.dispatch('initFristData')
          .then(()=>{
