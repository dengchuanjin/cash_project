    ...
    <el-dialog title="修改商户" :visible.sync="updateCashUserDialog">
      <el-form :model="newUser"  size="small">
        <el-form-item label="商户编号" :label-width="formLabelWidth" :required="isOff">
          <el-input v-model="newUser.Sid" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="电话" label-width="140px" :required="isOff">
        ...
        <el-form-item label="提现费率" :label-width="formLabelWidth" :required="isOff">
          <el-input v-model="newUser.SFreeRate" auto-complete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="银行卡号" label-width="140px" :required="isOff">
          <el-input v-model="newUser.SWorkerCard" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="是否每日自动提现" label-width="140px" :required="isOff">
        ...
        <el-form-item label="网售服务费" label-width="140px" :required="isOff">
          <el-input v-model="newUser.SWebSellFee" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="联系邮箱" label-width="140px" :required="isOff">
        ...
        <el-form-item label="打折金额" label-width="140px" :required="isOff">
        ...
        <el-form-item label="班次提前多少分钟可微信购票" label-width="210px" :required="isOff">
          <el-input v-model="newUser.SSellTimeLimit" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="商户简介" label-width="140px" :required="isOff">
